...
type BeaconChainConfig struct {
	...
	CellSidecarSubnetCount                uint64           `yaml:"CELL_SIDECAR_SUBNET_COUNT" spec:"true"`                    // CellSidecarSubnetCount is the number of cell sidecar subnets used in the gossipsub protocol
	...
	// Cell Staging Values
	StagingSize uint8 `yaml:"STAGING_SIZE" spec:"false"`
	WindowSize  uint8 `yaml:"WINDOW_SIZE" spec:"false"`
